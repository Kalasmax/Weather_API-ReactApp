...
import tempMinIcon from "../images/mintemp.png"
import tempMaxIcon from "../images/maxtemp.png"
...
const WeatherCard = ({item}) => {
    ...
    return(<>
        ...
        <Card className="m-4">    
            ...
            <Card.Img variant="top" src={`http://openweathermap.org/img/wn/${item.weather[0].icon}@2x.png`} style={{width:"100px"}} alt="icon" />
